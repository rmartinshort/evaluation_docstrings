...
class DocStringEvaluationPrompt:
    ...
    You should evaluate the quality of the docstrings by giving a binary (yes/no) response to each of the following citeria:

    1. Accuracy: Do the docstrings accurately explain what the code is doing? It is very important that they do not mislead readers.
    2. Clarity: Are the docstrings well written and contain enough information so that a junior engineer could understand what the code is doing?
    ...
    Read the code and docstrings carefully before you judge. Take note of the following instructions:
